            ...
            for i in "${tags[@]}" ; do
                ...
                case ${i:0:1} in
                    ...
                    ':')
                        ...
                        echo "%{F-}    %{B-}" # TODO Add your formatting tags for occupied workspaces
                        ;;
                    '!')
                        # ! the tag contains an urgent window
                        echo "%{F-}    %{B-}" # TODO Add your formatting tags for workspaces with the urgent hint
                        ;;
                    '-')
                        # - the tag is viewed on a monitor that is not focused
                        echo "%{F-}    %{B-}" # TODO Add your formatting tags for visible but not focused workspaces
                        ;;
                    *)
                        # . the tag is empty
